...
private struct SetTimerView: View {
    ...
    fileprivate var body: some View {
        VStack {
            ...
            TimerCreateBtnView(timerViewMode: timerViewModel)
...
private struct TimerCreateBtnView: View {
    @ObservedObject private var timerViewMode: TimerViewModel
    
    fileprivate init(timerViewMode: TimerViewModel) {
        self.timerViewMode = timerViewMode
    }
    
    fileprivate var body: some View {
        Button(
            action: {
                timerViewMode.settingBtnTapped()
            },
            label: {
                Text("설정하기")
